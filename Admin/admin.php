...
<body class="app sidebar-mini">
	<header class="app-header"><a class="app-header__logo" href="pages/trangchu.php">Bất Động Sản</a>
	...
	if (isset($_GET['page_layout'])) {
		switch ($_GET['page_layout']) {
			case 'product':
				include_once('admin/products/product.php');
				break;
			case 'add_product':
				include_once('admin/products/add_product.php');
				break;
			case 'edit_product':
				include_once('admin/products/edit_product.php');
				break;
			case 'del_product':
				include_once('admin/products/del_product.php');
				break;
